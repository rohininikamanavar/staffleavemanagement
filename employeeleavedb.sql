...
INSERT INTO `tblleaves` (`id`, `LeaveType`, `ToDate`, `FromDate`, `Description`,`DaysOutstand`, `PostingDate`, `AdminRemark`, `AdminRemarkDate`, `Status`, `IsRead`, `empid`) VALUES
...
INSERT INTO `tblleavetype` (`id`, `LeaveType`, `Description`,`DaysOutstand`, `CreationDate`) VALUES
