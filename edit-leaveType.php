                        ...
                        <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                 ...
                                 <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label for="example-leave-input" class="col-form-label">Available Leaves</label>
                                            <input class="form-control" name="avleaves" type="text"  value="<?php echo htmlentities($result->DaysOutstand);?>" readonly autocomplete="off" required id="example-leave-input">
                                        </div>
